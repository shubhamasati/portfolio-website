...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  href="#contact"
                  className="inline-flex items-center justify-center px-8 py-4 border-2 border-indigo-600 text-indigo-600 dark:text-indigo-400 font-semibold rounded-lg hover:bg-indigo-600 hover:text-white transition-colors"
                >
                  Get In Touch
                </Link>
              </div>
            ...
            >
              <div className="relative">
                <div className="w-80 h-80 rounded-full bg-gradient-to-br from-indigo-400 to-purple-600 p-1">
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              Recent thoughts and tutorials I've shared
            </p>
          </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[1, 2, 3].map((i) => (
                <motion.div
                  ...
                  className="bg-white dark:bg-gray-700 rounded-lg shadow-sm p-6 animate-pulse"
                >
                  <div className="h-48 bg-gray-200 dark:bg-gray-600 rounded-lg mb-4" />
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {blogs.map((blog, index) => (
                <motion.article
                  ...
                  transition={{ duration: 0.6, delay: index * 0.1 }}
                  whileHover={{ y: -5 }}
                  className="bg-white dark:bg-gray-700 rounded-lg shadow-sm overflow-hidden hover:shadow-lg transition-all duration-300"
                >
